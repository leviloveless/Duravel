...
**Launch prices:** **$19.99 / month** and **$119.99 / year** (no card required for the 14‑day trial — the trial is enforced app‑side, there is deliberately no Stripe trial).
...
1. **Product:** "Duravel" (or "Duravel Membership"). One product with two recurring prices is cleanest:
   ...
   - **Annual** — Recurring, **$119.99 USD**, billing period **Yearly**. Save → copy the **Price ID** (`price_...`).
